...
////////////////////////////////////////////////////////////////////////////////
void test4() { // check for elimination of 2 pairs of complimentary symbols
    var(A); var(B); var(C);
    KnowledgeBase kb;
    kb += A|B;
    kb += ~A|~B;
...
////////////////////////////////////////////////////////////////////////////////
void test6() { // simple "cannot prove test"
    var(A); var(B); var(C);
    KnowledgeBase kb;
    kb += A;
    CNF alpha = ~A;
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
void test8() { //only USEFUL rules are inserted
    Literal S[4][4] = {
